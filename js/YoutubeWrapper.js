...
YoutubeWrapper.prototype.playerQualityChangeEvent_ = function() {
	...
	console.log("@AT: Playback quality: " + this.ytPlayer.getPlaybackQuality());		// @AT
}
...
YoutubeWrapper.prototype.playerStateChangeEvent_ = function() {
	...
	console.log('@AT: YoutubeWrapper.js: playerStateChangeEvent_: ' + this.getStateText_());
	...
	if(this.getStateText_() === "playing") {
		...
		console.log(Date.now(),' @AT: Starting UPDATE_PROGRESS_EVENT_INTERVAL');
		/*
		this.periodicTimer = setInterval(function() {
			console.log(Date.now(),' @AT Periodic Timer');
		}.bind(this), 1000);
		*/
...
YoutubeWrapper.prototype.playerUpdateProgressEvent_ = function() {
	console.debug(Date.now(), "YoutubeWrapper.js: playerUpdateProgressEvent_()");
...
// @AT: Added function to get playback quality
YoutubeWrapper.prototype.getPlaybackQuality = function() {
	console.debug("YoutubeWrapper.js: getPlaybackQuality()");
	return this.ytPlayer.getPlaybackQuality();
}

YoutubeWrapper.prototype.getVideoLoadedFraction = function() {
	console.debug("YoutubeWrapper.js: getVideoLoadedFraction()");
